object FPM100Prt: TFPM100Prt
  Left = 390
  Top = 230
  Caption = #49373#49328' '#51077#44256
  ClientHeight = 512
  ClientWidth = 994
  Color = clBtnFace
  ...
  object sgMain: TAdvStringGrid
    ...
    ColumnHeaders.Strings = (
      ...
      #51077#44256#47749#49464#48264#54840
      #51228#49345#54408#53076#46300
      #51228#49345#54408#47749
      'CAT NO'
      #51077#44256#45800#50948
      #49884#47532#50620#48264#54840
      #51652#54665#49345#53468
      #50724#45908#45800#50948#45233#44060#49688#47049
      #50724#45908#49688#47049
      #51077#44256#49688#47049
      #51077#44256#44160#49688#49688#47049
      #44144#47000#52376#53076#46300
      #44144#47000#52376#47749
      #48176#49569#44428#50669
      #48376#49324#45812#45817#51088
      #48708#44256
      #49440#52636#44256#50668#48512
      #48152#54408#52636#44256#44144#47000#47749#49464#48264#54840
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT EXP_DATE, a.ORDER_NO, a.ITEM_CODE, ITEM_NAME, CATNO, a.OR' +
        'DER_UNIT, SERIAL_NO,'
      '       d.CODE_SNM, ORDER_EA_UNIT      ,QTY      ,INOUT_QTY'
      '      ,CHECK_QTY       ,a.CUST_CODE, CUST_NAME'
      
        '      ,a.CUST_TRANS      ,MANAGER      ,REMARKS      ,PRE_INOUT,' +
        ' RETURN_EX_NO'
      
        '      ,e.CODE_SNM      ,a.I_DATE      ,a.I_ID      ,a.U_DATE    ' +
        '  ,a.U_ID'
      
        '      ,DANGA      ,TORDER_PRICE,ORDER_CLOSE,RDY_LOC      ,ORDER_' +
        'STAT, a.ITEM_GUBUN'
      '  FROM PM100 a'
      '  JOIN MT300 b'
      ...
      '  JOIN MT900 d'
      '    on code_tp = '#39'0001'#39
      '   and a.ORDER_STAT = d.code_cd'
      '   and code_cd <> '#39'99'#39'       '
      '  JOIN MT900 e'
      '    on e.code_tp = '#39'0004'#39
      '   and a.ITEM_GUBUN = e.code_cd'
      '   and e.code_cd <> '#39'99'#39
      '  JOIN PD112 f'
      '    ON a.ORDER_TYPE = f.ORDER_TYPE'
      '   AND a.ORDER_NO   = f.ORDER_NO'
      '   AND a.ITEM_CODE  = f.ITEM_CODE'
      '   AND a.ORDER_UNIT = f.ORDER_UNIT'
      ' WHERE a.ORDER_TYPE = '#39'1000'#39
      '   AND INOUT_GUBUN  = '#39'I'#39
      '   AND a.ITEM_GUBUN = '#39'G'#39
      '   AND b.CATNO     like :CATNO'
      '   AND a.ITEM_CODE like :ITEM_CODE'
      '   AND EXP_DATE BETWEEN :EXP_DATE1 AND :EXP_DATE2'
      '   AND a.ITEM_GUBUN = '#39'G'#39
      'ORDER BY EXP_DATE, ORDER_NO, ITEM_CODE')
    Left = 88
    Top = 176
    ParamData = <
      item
