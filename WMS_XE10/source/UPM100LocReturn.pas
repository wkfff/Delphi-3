...
var
  FPM100LocReturn: TFPM100LocReturn;
...
procedure TFPM100LocReturn.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100LocReturn ,'FPM100LocReturn');
end;

procedure TFPM100LocReturn.FormDestroy(Sender: TObject);
begin
  FPM100LocReturn := nil;
end;

procedure TFPM100LocReturn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100LocReturn.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100LocReturn.Button1Click(Sender: TObject);
begin
...
procedure TFPM100LocReturn.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100LocReturn.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100LocReturn.FormCreate(Sender: TObject);
begin       
...
procedure TFPM100LocReturn.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100LocReturn.pr_Grid_Init;
begin
...
procedure TFPM100LocReturn.pr_Clear;
begin

end;

procedure TFPM100LocReturn.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);  
...
procedure TFPM100LocReturn.pr_Ready;
begin

end;

procedure TFPM100LocReturn.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100LocReturn.SpeedButton1Click(Sender: TObject);
begin
  try
