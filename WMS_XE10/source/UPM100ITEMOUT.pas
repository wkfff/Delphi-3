...
procedure TFPM100ITEMOUT.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100ITEMOUT.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100ITEMOUT.Button1Click(Sender: TObject);
begin
...
procedure TFPM100ITEMOUT.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100ITEMOUT.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100ITEMOUT.FormDestroy(Sender: TObject);
begin
  FPM100ITEMOUT := nil;
end;

procedure TFPM100ITEMOUT.FormCreate(Sender: TObject);
begin
...
procedure TFPM100ITEMOUT.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100ITEMOUT.pr_Grid_Init;
begin
...
procedure TFPM100ITEMOUT.pr_Clear;
begin

end;

procedure TFPM100ITEMOUT.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100ITEMOUT.pr_Ready;
begin

end;

procedure TFPM100ITEMOUT.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100ITEMOUT.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100ITEMOUT ,'FPM100ITEMOUT');
end;

procedure TFPM100ITEMOUT.SpeedButton1Click(Sender: TObject);
begin
  try
