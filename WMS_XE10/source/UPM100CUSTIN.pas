...
procedure TFPM100CUSTIN.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100CUSTIN ,'FPM100CUSTIN');
end;

procedure TFPM100CUSTIN.FormDestroy(Sender: TObject);
begin
  FPM100CUSTIN := nil;
end;

procedure TFPM100CUSTIN.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100CUSTIN.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100CUSTIN.Button1Click(Sender: TObject);
begin
...
procedure TFPM100CUSTIN.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100CUSTIN.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100CUSTIN.FormCreate(Sender: TObject);
begin
...
procedure TFPM100CUSTIN.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100CUSTIN.pr_Grid_Init;
begin
    ...
    with sgMain do begin
       ...
       gcMGridAlign[CD_QTY_UNIT  ] := 'C'; //ColWidths[M_SEQN_NUMB  ] := 50;
...
procedure TFPM100CUSTIN.pr_Clear;
begin

end;

procedure TFPM100CUSTIN.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100CUSTIN.pr_Ready;
begin

end;

procedure TFPM100CUSTIN.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100CUSTIN.SpeedButton1Click(Sender: TObject);
begin
  try
