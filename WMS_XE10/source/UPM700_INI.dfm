object FPM700_INI: TFPM700_INI
  ...
  object Panel3: TPanel
    ...
    object Label2: TLabel
      ...
      Width = 72
      Height = 12
      Caption = #47196#52992#51060#49496#44396#48516
      Color = clBtnFace
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -12
    ...
    object Label9: TLabel
      ...
      Width = 48
      Height = 12
      Caption = #51116#44256#45800#50948
      Color = clBtnFace
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -12
    ...
    object cedtSTOCK_QTY: TCurrencyEdit
      Left = 392
      Top = 14
      Width = 73
      Height = 21
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
      'SELECT c.CODE_SNM'
        ...
        '      ,substring(LOC_CODE,1,1)+'#39'-'#39'+substring(LOC_CODE,2,2)+'#39'-'#39'+s' +
        'ubstring(LOC_CODE,4,2)+'#39'-'#39'+substring(LOC_CODE,6,1) LOC_CODE'
      '      ,d.CODE_SNM'
      '      ,CATNO'
      '      ,ITEM_NAME'
      '      --,a.QTY'
      '      --,cast(a.QTY_EA as varchar(60))+'#39'/'#39'+ORDER_UNIT ORDER_UNIT'
      #9'  ,a.STOCK_QTY'
      '      ,cast(b.QTY as varchar(60))+'#39'/'#39'+b.QTY_UNIT STOCK_UNIT'
      '      ,a.I_DATE'
      '      ,a.I_ID'
      '      ,a.U_DATE'
      '      ,a.U_ID'
      ...
      '  JOIN MT900 c'
      '    ON a.LOC_GUBUN = c.CODE_CD'
      '   AND c.CODE_TP = '#39'4000'#39
      '   AND c.CODE_CD <> '#39#39
      '  JOIN MT900 d'
      '    ON b.ITEM_GUBUN = d.CODE_CD'
      '   AND d.CODE_TP    = '#39'2000'#39
      '   AND d.CODE_CD    <> '#39#39
      ...
      '   AND A.STOCK_QTY > 0'
      'ORDER BY LOC_CODE, CATNO, ITEM_NAME')
    Left = 88
    Top = 176
    ParamData = <
      item
