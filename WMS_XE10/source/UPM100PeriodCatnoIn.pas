...
type
  TFPM100PeriodCatnoIn = class(TForm)
    qryOpen: TQuery;
...
var
  FPM100PeriodCatnoIn: TFPM100PeriodCatnoIn;
...
procedure TFPM100PeriodCatnoIn.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100PeriodCatnoIn ,'FPM100PeriodCatnoIn');
end;

procedure TFPM100PeriodCatnoIn.FormDestroy(Sender: TObject);
begin
  FPM100PeriodCatnoIn := nil;
end;

procedure TFPM100PeriodCatnoIn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100PeriodCatnoIn.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100PeriodCatnoIn.Button1Click(Sender: TObject);
begin
...
procedure TFPM100PeriodCatnoIn.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100PeriodCatnoIn.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100PeriodCatnoIn.FormCreate(Sender: TObject);
begin     
...
procedure TFPM100PeriodCatnoIn.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100PeriodCatnoIn.pr_Grid_Init;
begin
...
procedure TFPM100PeriodCatnoIn.pr_Clear;
begin

end;

procedure TFPM100PeriodCatnoIn.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100PeriodCatnoIn.pr_Ready;
begin

end;

procedure TFPM100PeriodCatnoIn.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100PeriodCatnoIn.SpeedButton1Click(Sender: TObject);
begin
...
procedure TFPM100PeriodCatnoIn.sbnLine_S01Click(Sender: TObject);
begin
