...
procedure TFPM100Nor.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100Nor.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100Nor.FormCreate(Sender: TObject);
begin      
...
procedure TFPM100Nor.edtLOC_CODEKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then SelectNext(sender as tWincontrol, true, true);
  if key = #13 then key := #0;
end;

procedure TFPM100Nor.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100Nor.FormDestroy(Sender: TObject);
begin
  FPM100Nor := nil;
end;

procedure TFPM100Nor.pr_Clear;
begin

end;

procedure TFPM100Nor.pr_Grid_Init;
begin
...
procedure TFPM100Nor.pr_qryOpen;
begin        
  pr_ClearGrid(sgMain);
...
procedure TFPM100Nor.pr_Ready;
begin

end;

procedure TFPM100Nor.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100Nor.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100Nor ,'FPM100Nor');
end;

procedure TFPM100Nor.sbnLine_S01Click(Sender: TObject);
begin
...
procedure TFPM100Nor.edtLOC_CODEExit(Sender: TObject);
begin
  Abort;
end;

procedure TFPM100Nor.Button1Click(Sender: TObject);
begin
  pr_qryOpen;
end;

procedure TFPM100Nor.Button2Click(Sender: TObject);
begin
