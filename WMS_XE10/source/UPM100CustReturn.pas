...
var
  FPM100CustReturn: TFPM100CustReturn;
...
procedure TFPM100CustReturn.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100CustReturn ,'FPM100CustReturn');
end;

procedure TFPM100CustReturn.FormDestroy(Sender: TObject);
begin
  FPM100CustReturn := nil;
end;

procedure TFPM100CustReturn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100CustReturn.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100CustReturn.Button1Click(Sender: TObject);
begin
...
procedure TFPM100CustReturn.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100CustReturn.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100CustReturn.FormCreate(Sender: TObject);
begin
...
procedure TFPM100CustReturn.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100CustReturn.pr_Grid_Init;
begin
    ...
    with sgMain do begin
       ...
       gcMGridAlign[CD_INOUT_QTY ] := 'R'; //ColWidths[M_SEQN_NUMB  ] := 50;
       ...
       gcMGridAlign[CD_EXP_DATE  ] := 'C'; //ColWidths[M_VBELN      ] := 41;
       gcMGridAlign[CD_I_ID      ] := 'C'; //ColWidths[M_DLV_CUST_NM] := 160;
    end;
end;

procedure TFPM100CustReturn.pr_Clear;
begin

end;

procedure TFPM100CustReturn.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100CustReturn.pr_Ready;
begin

end;

procedure TFPM100CustReturn.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100CustReturn.SpeedButton1Click(Sender: TObject);
begin
  try
