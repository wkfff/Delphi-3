object FPM100Ret: TFPM100Ret
  Left = 390
  Top = 230
  Caption = #48152#54408' '#51077#44256
  ClientHeight = 512
  ClientWidth = 994
  Color = clBtnFace
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT EXP_DATE, ORDER_NO, a.ITEM_CODE, ITEM_NAME, CATNO, ORDER_' +
        'UNIT,'
      ...
      ' WHERE ORDER_TYPE  = '#39'3000'#39
      '   AND INOUT_GUBUN = '#39'O'#39
