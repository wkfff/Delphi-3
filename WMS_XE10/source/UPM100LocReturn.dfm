object FPM100LocReturn: TFPM100LocReturn
  Left = 244
  Top = 162
  Caption = 'LOC'#48324' '#48152#54408#51077#44256#45236#50669
  ClientHeight = 512
  ClientWidth = 994
  Color = clBtnFace
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT distinct substring(D.LOC_CODE,1,1)+'#39'-'#39'+substring(D.LOC_CO' +
        'DE,2,2)+'#39'-'#39'+substring(D.LOC_CODE,4,2)+'#39'-'#39'+substring(D.LOC_CODE,6' +
        ',1) LOC_CODE,'
      
        '                F.CODE_SNM, C.CATNO, C.ITEM_NAME, D.INOUT_QTY, C' +
        'AST(B.ORDER_EA_UNIT as VARCHAR(8))+'#39'/'#39'+B.ORDER_UNIT,'
      ...
      '  AND D.LOC_CODE BETWEEN :LOC_CODE1 AND :LOC_CODE2'
