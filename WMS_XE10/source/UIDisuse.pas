...
type
  TFIDisuse = class(TForm)
    ...
    Label8: TLabel;
    Label10: TLabel;
    qryMainDISUSE_DATE: TStringField;
    Label11: TLabel;
    DBEdit7: TDBEdit;
    Panel1: TPanel;
    pnlMessage: TPanel;
...
procedure TFIDisuse.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFIDisuse.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFIDisuse.Button1Click(Sender: TObject);
begin
  pr_qryOpen('%%');
end;

procedure TFIDisuse.Button2Click(Sender: TObject);
begin
  DBGrid2Excel('', DBGrid1);
end;

procedure TFIDisuse.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFIDisuse.FormDestroy(Sender: TObject);
begin
  FIDisuse := nil;
end;

procedure TFIDisuse.FormCreate(Sender: TObject);
begin
  edBarcode.Clear;
  ...
  giCount := 0;
  //gsJOBS  := gcDiuse;
  gsJOBS  := AITEM_STATE[gcDiuse];
  Button1Click(Self);
end;

procedure TFIDisuse.Button3Click(Sender: TObject);
var
...
procedure TFIDisuse.Button5Click(Sender: TObject);
var
  lsORGAN_CODE : String;
begin
{
...
procedure TFIDisuse.edBarcodeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFIDisuse.pr_qryOpen(ABarcode:String);
begin
  qryMain.Close;
