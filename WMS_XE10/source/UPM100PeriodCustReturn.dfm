object FPM100PeriodCustReturn: TFPM100PeriodCustReturn
  Left = 390
  Top = 157
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
      ...
      '                SUM(B.ORDER_EA_UNIT * B.QTY),'
        ...
        '  SUM(B.ORDER_EA_UNIT * D.INOUT_QTY), SUM(B.DANGA * B.QTY), SUM(' +
        'B.DANGA * D.INOUT_QTY)'
      ''
      'FROM ('
      ...
      'GROUP BY E.CUST_NAME, D.EXP_DATE'
      'ORDER BY E.CUST_NAME, D.EXP_DATE')
    Left = 48
    Top = 208
    ParamData = <
      item
