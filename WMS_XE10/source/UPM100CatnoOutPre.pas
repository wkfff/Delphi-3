...
type
  TFPM100CatnoOutPre = class(TForm)
    qryOpen: TQuery;
...
var
  FPM100CatnoOutPre: TFPM100CatnoOutPre;
...
procedure TFPM100CatnoOutPre.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100CatnoOutPre.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100CatnoOutPre.Button1Click(Sender: TObject);
begin
...
procedure TFPM100CatnoOutPre.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100CatnoOutPre.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100CatnoOutPre.FormDestroy(Sender: TObject);
begin
  FPM100CatnoOutPre := nil;
end; 

procedure TFPM100CatnoOutPre.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100CatnoOutPre ,'FPM100CatnoOutPre');
end;

procedure TFPM100CatnoOutPre.FormCreate(Sender: TObject);
begin
...
procedure TFPM100CatnoOutPre.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl,  True, True);
...
procedure TFPM100CatnoOutPre.pr_Grid_Init;
begin
...
procedure TFPM100CatnoOutPre.pr_Clear;
begin

end;

procedure TFPM100CatnoOutPre.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100CatnoOutPre.pr_Ready;
begin

end;

procedure TFPM100CatnoOutPre.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100CatnoOutPre.sbnLine_S01Click(Sender: TObject);
begin
