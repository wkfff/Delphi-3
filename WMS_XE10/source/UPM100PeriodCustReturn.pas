...
type
  TFPM100PeriodCustReturn = class(TForm)
    qryOpen: TQuery;
...
var
  FPM100PeriodCustReturn: TFPM100PeriodCustReturn;
...
procedure TFPM100PeriodCustReturn.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100PeriodCustReturn ,'FPM100PeriodCustReturn');
end;

procedure TFPM100PeriodCustReturn.FormDestroy(Sender: TObject);
begin
  FPM100PeriodCustReturn := nil;
end;

procedure TFPM100PeriodCustReturn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100PeriodCustReturn.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100PeriodCustReturn.Button1Click(Sender: TObject);
begin
...
procedure TFPM100PeriodCustReturn.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100PeriodCustReturn.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100PeriodCustReturn.FormCreate(Sender: TObject);
begin               
...
procedure TFPM100PeriodCustReturn.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100PeriodCustReturn.pr_Grid_Init;
begin
...
procedure TFPM100PeriodCustReturn.pr_Clear;
begin

end;

procedure TFPM100PeriodCustReturn.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100PeriodCustReturn.pr_Ready;
begin

end;

procedure TFPM100PeriodCustReturn.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100PeriodCustReturn.SpeedButton1Click(Sender: TObject);
begin
  try
