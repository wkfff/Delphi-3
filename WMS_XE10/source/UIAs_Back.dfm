object FIAs_Back: TFIAs_Back
  Left = 238
  Top = 114
  Width = 1024
  Height = 742
  ActiveControl = edBarcode
  Caption = 'A/S '#48152#54408' '#44288#47532
  Color = clBtnFace
  ...
  object qryMain: TQuery
    ...
    SQL.Strings = (
      ...
      '  LEFT JOIN dbo.SPD101 f'
      '    ON a.BARCODE = f.BARCODE    '
      '   and f.STDT_DATE  = a.AS_BACK_DATE'
      '   and f.CLOSE_DATE = '#39'99991231'#39
      'where a.BARCODE like :BARCODE'
      '  and a.ITEM_STATE = :ITEM_STATE'
      '  and a.CLOSE_DATE = '#39'99991231'#39
      '  and a.AS_BACK_DATE between :PRDT_DATE1 and :PRDT_DATE2')
    Left = 88
    Top = 176
    ParamData = <
      item
    ...
    object qryMainREMARKS_AS: TStringField
      FieldName = 'REMARKS_AS'
      FixedChar = True
      Size = 100
    end
  end
