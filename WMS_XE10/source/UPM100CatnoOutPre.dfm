object FPM100CatnoOutPre: TFPM100CatnoOutPre
  Left = 390
  Top = 186
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT distinct C.CATNO, C.ITEM_NAME, F.CODE_SNM, A.ORDER_NO,  B' +
        '.QTY,'
      '        CAST(B.ORDER_EA_UNIT as VARCHAR(8))+'#39'/'#39'+B.ORDER_UNIT,'
