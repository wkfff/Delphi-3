object FPM100PeriodCatnoReturn: TFPM100PeriodCatnoReturn
  Left = 238
  Top = 194
  Caption = #44592#44036#48324' '#51228#49345#54408#48324' '#48152#54408#45236#50669
  ClientHeight = 512
  ClientWidth = 994
  Color = clBtnFace
  ...
  object sgMain: TAdvStringGrid
    ...
    ColumnHeaders.Strings = (
      ...
      #48152#54408#50696#51221#49688#47049
      #48152#54408#49688#47049
      #48152#54408#50696#51221#44552#50529
  ...
  object grpS01: TGroupBox
    ...
    object Label3: TLabel
      ...
      Width = 56
      Height = 13
      Caption = #48152#54408#51068#51088
      Color = clBtnFace
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -13
    ...
    object Label2: TLabel
      ...
      Width = 84
      Height = 13
      Caption = #48152#54408#47749#49464#48264#54840
      Color = clBtnFace
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -13
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CONVERT(varchar(10),cast(D.EXP_DATE as datetime),(120)) E' +
        'XP_DATE, C.CATNO, max(C.ITEM_NAME),'
      '                SUM(B.ORDER_EA_UNIT * B.QTY),'
      
        '                SUM(B.ORDER_EA_UNIT * D.INOUT_QTY), SUM(B.DANGA ' +
        '* B.QTY), SUM(B.DANGA * D.INOUT_QTY)'
      ''
      'FROM ('
      ...
      ' AND F.CODE_CD    <> '#39#39
      'WHERE C.CATNO  like :CATNO'
      '  AND C.ITEM_GUBUN like :ITEM_GUBUN'
      '  AND D.EXP_DATE between :FR_DATE and :TO_DATE'
      'GROUP BY D.EXP_DATE, C.CATNO'
      'ORDER BY D.EXP_DATE, C.CATNO')
    Left = 48
    Top = 208
    ParamData = <
      item
