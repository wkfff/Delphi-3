...
procedure TFPM100CatnoIn.FormActivate(Sender: TObject);
begin
  FQMain.fn_ChildShow(TFPM100CatnoIn ,'FPM100CatnoIn');
end;

procedure TFPM100CatnoIn.FormDestroy(Sender: TObject);
begin
  FPM100CatnoIn := nil;
end;

procedure TFPM100CatnoIn.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFPM100CatnoIn.Button4Click(Sender: TObject);
begin
  Close;
end;

procedure TFPM100CatnoIn.Button1Click(Sender: TObject);
begin
...
procedure TFPM100CatnoIn.Button2Click(Sender: TObject);
begin
  fn_Grid2Excell(Self , sgMain);
end;

procedure TFPM100CatnoIn.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
...
procedure TFPM100CatnoIn.FormCreate(Sender: TObject);
begin        
...
procedure TFPM100CatnoIn.edITEM_CODEKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case key of
    VK_RETURN : SelectNext(Sender as TWinControl, True, True);
...
procedure TFPM100CatnoIn.pr_Grid_Init;
begin
    ...
    with sgMain do begin
       ...
       gcMGridAlign[CD_QTY       ] := 'C'; //ColWidths[M_MATNR_CNT  ] := 0;
...
procedure TFPM100CatnoIn.pr_Clear;
begin

end;

procedure TFPM100CatnoIn.pr_qryOpen;
var
  la : Array of Integer;
begin
  pr_ClearGrid(sgMain);
...
procedure TFPM100CatnoIn.pr_Ready;
begin

end;

procedure TFPM100CatnoIn.sgMainGetAlignment(Sender: TObject; ARow, ACol: Integer;
  var HAlign: TAlignment; var VAlign: TVAlignment);
begin
    HAlign := taCenter;
...
procedure TFPM100CatnoIn.sbnLine_S01Click(Sender: TObject);
begin
  try
