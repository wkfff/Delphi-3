object FPM100ITEMORDER: TFPM100ITEMORDER
  Left = 243
  Top = 175
  Width = 1037
  Height = 550
  ...
  object sgMain: TAdvStringGrid
    ...
    ColumnHeaders.Strings = (
      ...
      #52852#53448#47196#44536#48264#54840
      'KAN_CODE'
      ''
      '')
    Lookup = False
  ...
  object qryOpen: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT distinct(A.ORDER_NO), B.ITEM_CODE, C.ITEM_NAME, B.ORDER_U' +
        'NIT, B.QTY,'
      '  B.CUST_CODE,D.CUST_NAME, B.CUST_TRANS, C.CATNO, C.KAN_CODE'
      'FROM ('
      '  SELECT ORDER_NO FROM PM100'
      '  WHERE ORDER_CLOSE = '#39'Y'#39
      ' AND ORDER_STAT = '#39'00'#39
      ' AND ORDER_TYPE = '#39'2000'#39' ) A,'
      '  PM100 B, MT300 C, MT200 D'
      'WHERE '
      '  B.ITEM_CODE like :ITEM_CODE'
      '  AND B.CUST_CODE = D.CUST_CODE'
      '  AND A.ORDER_NO = B.ORDER_NO'
      '  AND C.ITEM_GUBUN like :ITEM_GUBUN'
      '  AND B.ITEM_CODE = C.ITEM_CODE'
      'ORDER BY B.ITEM_CODE, A.ORDER_NO, B.ORDER_UNIT')
    Left = 48
    Top = 208
    ParamData = <
      item
