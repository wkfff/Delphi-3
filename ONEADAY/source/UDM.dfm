object DM: TDM
  ...
  object dbMain: TDatabase
    ...
    LoginPrompt = False
    Params.Strings = (
      'DATABASE NAME=ONEADAY'
      'SERVER NAME=61.97.143.41\SQLEXPRESS'
      'USER NAME=sa'
  ...
  object ZConnection1: TZConnection
    Protocol = 'mysql-5'
    HostName = '61.97.143.41'
    Port = 3306
    Database = 'oneaday_ord'
    User = 'tsserver'
    Password = 'tsserver2201'
    Left = 40
    Top = 256
  end
  object qryOpenIF: TZQuery
