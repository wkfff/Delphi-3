...
type
  ECommError = class(Exception)
    ...
    Function ComOpen(D_Name:Pchar;baud:Pchar):Boolean;stdcall; export;
//    function GetPiSts(sPosChk:PChar;Var sRet:Pchar):Boolean; stdcall; export;
    function GetPiSts(iPiId:Integer):Boolean; stdcall; export;

    Function init(st_baud:Pchar):Integer;stdcall;
    Function Write(Write_Data : array of byte;Data_len : integer):Integer; stdcall; export;
    Function read(var Write_Data : Array of byte; Data_len : Integer):Integer; stdcall; export;
    Function Send_PI(Pi_Id,Floor :Integer;  pidata : PChar):Boolean; stdcall; export;

    Function Write_Str(Write_Data : String;Data_len : integer):Integer; stdcall; export;
    Function read_Str(var Write_Data : String; Data_len : Integer):Integer; stdcall; export;
    Function hangulZpl(Txt: string; Xpos, Ypos, Xaxis, Yaxis :integer; Rotation : Boolean) : string;stdcall; export;
    Function CheckStatus : integer;
    Function Z4M_prt: boolean; stdcall; export;
    function RTS(State: boolean): boolean; stdcall; export;
    Procedure SetHS(State: Integer);stdcall; export;
    Procedure Set_CRC(State : Integer); stdcall; export;
    function IsOpen(iPort:Integer):Boolean;stdcall; export;
    ...
    Function Close:Integer; stdcall; export;
    //통신crc16관련 함수
...
function GetPiSts(iPiId:Integer):Boolean; stdcall;
var
    i       : Integer;
    iChk    : Integer;
...
Procedure Set_CRC(State : Integer);stdcall;
Var
  i : Integer;
begin
    For i:= 1 To 10 Do
...
function IsOpen(iPort:Integer):Boolean;stdcall;
Begin
  Result := isConnect[iPort];
End;

function ComOpen(D_Name:Pchar;baud:Pchar):Boolean; stdcall;
var
  DeviceName : String;
  iPort      : Integer;
begin
    ...
    if ComFile[Com_Port] = INVALID_HANDLE_VALUE then
    begin
...
Function Write(Write_Data : array of byte ; Data_len : integer ):Integer;stdcall;
begin
...
Function read(var Write_Data :Array of byte; Data_len : Integer):Integer;stdcall;
Var
...
//문자열 출력
Function Send_PI(Pi_Id,Floor :Integer;  pidata : PChar):Boolean;stdcall;
var
  i       : Integer;
...
End;
//문자열 출력
Function Write_Str(Write_Data :String ; Data_len : integer ):Integer;stdcall;
var
   s: String;
begin
  s := Write_Data;
...
//통신 자료 읽기
Function read_Str(var Write_Data :String; Data_len : Integer):Integer;stdcall;
var
  d: array[1..Read_buf] of Char;
  ch_buf : String;
begin
...
//rts 제어
function RTS(State: boolean): boolean;stdcall;
begin
  case State of
...
Procedure SetHS(State: Integer);stdcall;
var
  DCB: TDCB;
begin
  case State of
...
Function Z4M_prt: boolean;stdcall;
var
  ii : Integer;
  sMsg : String;
begin
...
////////////////////////////////////////////////////////////////////////////////
function hangulZpl(Txt: string; Xpos, Ypos, Xaxis, Yaxis :integer; Rotation : Boolean) : string; stdcall;
var
   i, Len, Gap  : integer;
   KorTxt, Str1 : String;
