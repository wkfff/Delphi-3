...
Legal issues: Copyright (C) 1998-2010 by Fran?is PIETTE
...
const
  FtpServVersion      = 800;
  CopyRight : String  = ' FtpServ (c) 2014 dyddyd V8.00 ';
...
begin
    if not FInitialized then begin
        ...
        RootDirectory.Text := IniFile.ReadString(SectionData, KeyRoot, 'E:\download');
        if IS_TEST then
          RootDirectory.Text := FOLDER_TEST
        else
          RootDirectory.Text := FOLDER_RUN + '\schedule';
